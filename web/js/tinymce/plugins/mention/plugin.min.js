    ...
    AutoComplete.prototype = {
        ...
        offset: function () {
            var rtePosition = $(this.editor.getContainer()).offset(),
                contentAreaPosition = $(this.editor.getContentAreaContainer()).offset(),
                nodePosition = $(this.editor.dom.select('span#autocomplete')).offset();
            
            console.log(rtePosition);
            console.log(contentAreaPosition);
            console.log(nodePosition.top);
            console.log($(this.editor.selection.getNode()).innerHeight() - $(this.editor.getDoc()).scrollTop() + 5);
