			...
			<div class="infobox{if empty($asset['trailerVideoUrl']) && empty($files)} nomedia{/if}">
				...
				<p>
					{if $recommendedReleaseStable}
						...
						<a class="button square ico-button mod-dl" href="{formatDownloadTrackingUrl($recommendedReleaseStable['file'])}">{htmlspecialchars($recommendedReleaseStable['file']['name'])}</a>&nbsp;<a class="button square ico-button deps" href="/show/dependencies/{$recommendedReleaseStable['releaseId']}" target="_blank" title="Show Dependencies"></a>
					...
					{elseif $fallbackRelease}
						...
						<a class="button square ico-button mod-dl" href="{formatDownloadTrackingUrl($fallbackRelease['file'])}">{htmlspecialchars($fallbackRelease['file']['name'])}</a>&nbsp;<a class="button square ico-button deps" href="/show/dependencies/{$fallbackRelease['releaseId']}" target="_blank" title="Show Dependencies"></a>
					...
					{if $recommendedReleaseUnstable}
						...
						<a class="button square ico-button mod-dl" href="{formatDownloadTrackingUrl($recommendedReleaseUnstable['file'])}">{htmlspecialchars($recommendedReleaseUnstable['file']['name'])}</a>&nbsp;<a class="button square ico-button deps" href="/show/dependencies/{$recommendedReleaseUnstable['releaseId']}" target="_blank" title="Show Dependencies"></a>
				...
				{if !empty($releases)}
					{foreach from=$releases item=release}
						<tr data-assetid="{$release['assetId']}" {if !isset($first)} class="latest"{/if}>
							...
							<td>{if !empty($release['file'])}<div><a class="button square ico-button mod-dl" href="{formatDownloadTrackingUrl($release['file'])}">{htmlspecialchars($release['file']['name'])}</a><a class="button square ico-button deps" target="_blank" href="/show/dependencies/{$release['releaseId']}"></a></div>{/if}</td>
