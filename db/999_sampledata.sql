...
START TRANSACTION;
USE `moddb`;
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (1, 'examplemodone', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (2, 'examplemodtwo', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (3, 'examplemodthree', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (4, 'examplemodfour', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (5, 'examplemodfive', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (6, 'examplemodsix', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (7, 'examplemodseven', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (8, 'examplemodeight', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (9, 'examplemodnine', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (10, 'examplemodten', NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
