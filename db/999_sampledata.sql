...
START TRANSACTION;
USE `moddb`;
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (1, 'examplemodone', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (2, 'examplemodtwo', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (3, 'examplemodthree', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (4, 'examplemodfour', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (5, 'examplemodfive', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (6, 'examplemodsix', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (7, 'examplemodseven', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (8, 'examplemodeight', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (9, 'examplemodnine', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
INSERT INTO `moddb`.`mod` (assetid, urlalias, logofileid, homepageurl, sourcecodeurl, trailervideourl, issuetrackerurl, wikiurl, comments, side, created, lastreleased, supportedversions) VALUES (10, 'examplemodten', NULL, NULL, NULL, NULL, NULL, NULL, 0, 'both', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
...
INSERT INTO `moddb`.`asset` (createdbyuserid, editedbyuserid, statusid, assettypeid, code, name, text, tagscached, created, lastmodified, numsaved) VALUES (1,1,2,1,NULL,'Example Mod 3 loooonnng name name name name', '<p style="text-align: center;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque leo sem, ultrices vel enim vel, pretium fringilla nisi. Nunc ac massa hendrerit, semper est sed, blandit eros. Sed at placerat lorem, viverra lacinia nibh. Mauris eu nunc a augue rhoncus pharetra ac eu nulla. Fusce elementum sapien sit amet sapien pellentesque, eget porttitor quam eleifend. Maecenas imperdiet justo dolor, id bibendum purus ornare vel. Morbi commodo porttitor nisi, sed finibus eros blandit eget. Nulla quis rhoncus urna.</p>', '', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1);
