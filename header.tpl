	...
	<div class="content">
		...
		<div class="navigation">
			<ul>
				...
				<li class="mainmenuitem {if in_array($urltarget, array('list/mod'))}active{/if}" style="margin-left:10px;"><a href="/list/mod">Mods</a></li>
				
				{if (!empty($user))}
					{if ($user['rolecode'] == 'admin')}
					<li class="mainmenuitem {if in_array($urltarget, array('list/user', 'list/tag', 'list/connectiontype', 'list/stati', 'list/assettypes'))}active{/if}" style="margin-left:5px;">
						<a href="#">Admin</a>
						<ul class="submenu">
